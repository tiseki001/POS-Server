...
where year(订购日期) in (2011,2012) and 订单.订单ID = 订单明细.订单ID  and 产品.产品ID=订单明细.产品ID and 产品.类别ID=类别.类别ID and 订单.货主城市 in ('北京','成都','大连','昆明' ,'南京','南昌','上海','深圳') 
group by 货主城市]]></Query>
</TableData>
</TableDataMap>
...
<AttrMarkerType>
<Attr markerType="SquareFilledMarker"/>
</AttrMarkerType>
</Attr>
<Attr class="com.fr.chart.base.AttrAxisPosition">
<AttrAxisPosition>
