<#--
  ...
  under the License.
  -->
<script language="javascript" type="text/javascript" src="<@ofbizReportUrl>/images/jquery/plugins/jsTree/jquery.jstree.js</@ofbizReportUrl>"></script>
