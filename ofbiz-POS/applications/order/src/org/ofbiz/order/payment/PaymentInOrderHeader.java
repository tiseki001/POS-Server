...
public class PaymentInOrderHeader {
	...
	private BigDecimal amount;				 //缴款总金额
	...
	private String docType;              //单据类型（0：中途缴款，1：日结账）
	...
	public String toString() {
		return "PaymentInOrderHeader [docId=" + docId + ", docNo=" + docNo
				+ ", partyId=" + partyId + ", storeId=" + storeId
				+ ", baseEntry=" + baseEntry + ", extSystemNo=" + extSystemNo
				+ ", extDocNo=" + extDocNo + ", postingDate=" + postingDate
				+ ", docStatus=" + docStatus + ", amount=" + amount + ", memo="
				+ memo + ", createUserId=" + createUserId + ", createDocDate="
				+ createDocDate + ", lastUpdateUserId=" + lastUpdateUserId
				+ ", lastUpdateDocDate=" + lastUpdateDocDate
				+ ", approvalUserId=" + approvalUserId + ", approvalDate="
				+ approvalDate + ", isSync=" + isSync + ", printNum="
				+ printNum + ", docType=" + docType + ", attrName1="
				+ attrName1 + ", attrName2=" + attrName2 + ", attrName3="
				+ attrName3 + ", attrName4=" + attrName4 + ", attrName5="
				+ attrName5 + ", attrName6=" + attrName6 + ", attrName7="
				+ attrName7 + ", attrName8=" + attrName8 + ", attrName9="
				+ attrName9 + "]";
	}
