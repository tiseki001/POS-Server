...
public class BackOrderHeader {
	private String docId;                //退订单ID：主键
	private Long   docNo; 				 //退订单号码（纯数字）
	...
	public void setPreRefundAmount(BigDecimal preRefundAmount) {
	...
	public String getPreRefundStoreId() {
		return preRefundStoreId;
	}
	public void setPreRefundStoreId(String preRefundStoreId) {
		this.preRefundStoreId = preRefundStoreId;
	}
