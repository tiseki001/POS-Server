...
public class PreOrderDtl {
	...
	private Long quantity;			    //预订数量
	private Long saleQuantity;          //销售数量 new
	private Long backQuantity;          //退订数量
	private BigDecimal rebateAmount;    //金额   new
	private BigDecimal bomAmount;       //套包金额   new
	private String memo;				//备注
	private String productSalesPolicyId;//销售政策ID
	private Long  productSalesPolicyNo; //销售政策NO new
	...
	private String bomName;             //套包Name(表无)
	...
	//构造方法
	public PreOrderDtl() {}
	public PreOrderDtl(String docId) {
		this.docId = docId;
	}
	...
	public Long getBackQuantity() {
		return backQuantity;
	}
	public void setBackQuantity(Long backQuantity) {
