...
<div class="screenlet">
    ...
    <form method='post' action='<@ofbizUrl>${formType}</@ofbizUrl>' id="_form_SaveSalesPolicyPackage" name="selectAllForm">
       <input type='hidden' name="partyId" id="partyId" value="${partyId}"/>
       <table border="1" class="basic-table" id="tab">
          <tr class="header-row" id="0">
            <td><input type='hidden' name="rowCount_o_0" id="rowCount0" value="0"/></td>
          ...
          <#assign rowCount = 1>
          <#if productSalesPolicyBoms?has_content>
          <#list productSalesPolicyBoms as productSalesPolicyBom>
	          ...
	          <td><input type='text' name="left1_o_${rowCount}" id="left1${rowCount}" value="${productSalesPolicyBom.left1?if_exists}" size='15' readOnly='true'/></td>
              <td><input type='text' name="fieldName_o_${rowCount}" id="fieldName${rowCount}" value="${productSalesPolicyBom.fieldName?if_exists}" size='15' readOnly='true'/></td>
              <td><input type='text' name="operate_o_${rowCount}" id="operate${rowCount}" value="${productSalesPolicyBom.operate?if_exists}" size='15' readOnly='true'/></td>
              <td><input type='text' name="value1_o_${rowCount}" id="value1${rowCount}" value="${productSalesPolicyBom.value1?if_exists}" size='15' readOnly='true'/></td>
              <td><input type='text' name="right1_o_${rowCount}" id="right1${rowCount}" value="${productSalesPolicyBom.right1?if_exists}" size='15' readOnly='true'/></td>
              <td><input type='text' name="relation_o_${rowCount}" id="relation${rowCount}" value="${productSalesPolicyBom.relation?if_exists}" size='15' readOnly='true'/></td>
       ...
       <table border="1" class="basic-table" >
          ...
          <tr>
          	<td colspan="11" align="center">
	            ...
	            <input type="button" value='${uiLabelMap.CommonFind}' id="commit"/>
            </td>
           </tr>
        </table>
    </div>
	...
	$("#tab tr").attr("align","center");
		...
		$("#but").click(function(){
			...
			$("#tab").append("<tr class='header-row' id="+_len+" align='center'>"
	                         ...
	                         +"<td><input type='text' name='left1_o_"+_len+"' id='left1"+_len+"' value='"+leftVal+"' size='15' readOnly='true'/></td>"
	                         +"<td><input type='text' name='fieldName_o_"+_len+"' id='fieldName"+_len+"' value='"+fieldNameVal+"' size='15' readOnly='true'/></td>"
	                         +"<td><input type='text' name='operate_o_"+_len+"' id='operate"+_len+"' value='"+operateVal+"' size='15' readOnly='true'/></td>"
	                         +"<td><input type='text' name='value1_o_"+_len+"' id='value1"+_len+"' value='"+value1Val+"' size='15' readOnly='true'/></td>"
	                         +"<td><input type='text' name='right1_o_"+_len+"' id='right1"+_len+"' value='"+righ1Val+"' size='15' readOnly='true'/></td>"
		                     +"<td><input type='text' name='relation_o_"+_len+"' id='relation"+_len+"' value='"+relationVal+"' size='15' readOnly='true'/></td>"
