...
<div class="screenlet">
    ...
    <form method='post' action='<@ofbizUrl>CreateProductPromoStore</@ofbizUrl>' id="_form_CreateProductPromoStore" name="selectAllForm">
       <table border="1" class="basic-table" id="tab">
          ...
          <#list productPromoStores as productPromoStore>
	          ...
	          <td><input type='text' name="left1_o_${rowCount}" id="left1${rowCount}" value="${productPromoStore.left1?if_exists}" size='15'/></td>
              <td><input type='text' name="fieldName_o_${rowCount}" id="fieldName${rowCount}" value="${productPromoStore.fieldName?if_exists}" size='15'/></td>
              <td><input type='text' name="operate_o_${rowCount}" id="operate${rowCount}" value="${productPromoStore.operate?if_exists}" size='15'/></td>
              <td><input type='text' name="value1_o_${rowCount}" id="value1${rowCount}" value="${productPromoStore.value1?if_exists}" size='15'/></td>
              <td><input type='text' name="right1_o_${rowCount}" id="right1${rowCount}" value="${productPromoStore.right1?if_exists}" size='15'/></td>
              <td><input type='text' name="relation_o_${rowCount}" id="relation${rowCount}" value="${productPromoStore.relation?if_exists}" size='15'/></td>
       ...
       <table border="1" class="basic-table" >
          <tr class="header-row">
            ...
            <td ><b>${uiLabelMap.Value1}</b>
            	<input id="_value1" type="text" size="7" name="value1"></input>
            </td>
...
<script>
	...
	$("#commit").click(function(){
		$("#_form_CreateProductPromoStore").submit();
	});
