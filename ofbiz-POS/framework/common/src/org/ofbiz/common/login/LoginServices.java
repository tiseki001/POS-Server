...
public class LoginServices {
    ...
    public static Map<String, Object> updatePassword(DispatchContext ctx, Map<String, ?> context) {
        ...
        if (UtilValidate.isNotEmpty(externalAuthId)) {
            ...
            userLoginToUpdate.set("isSync", Constant.ONE);
    ...
    public static boolean checkPassHis(DispatchContext ctx,String userLoginId){
        boolean bRet = false;
        Delegator delegator = ctx.getDelegator();
        try {
            List<GenericValue> pwdHistList = delegator.findByAnd("UserLoginPasswordHistory", UtilMisc.toMap("userLoginId",userLoginId),UtilMisc.toList("-fromDate"));
    ...
    public static Map<String, Object> updatePosPassword(DispatchContext ctx, Map<String, ?> context) {
        Delegator delegator = ctx.getDelegator();
        //Security security = ctx.getSecurity();
        //GenericValue loggedInUserLogin = (GenericValue) context.get("userLogin");
        Locale locale = (Locale) context.get("locale");
